...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args }) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'edukasi', 'news', 'random', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'virus', 'host', 'fun', 'jadian',  'database','quran', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
® ${pmenus} OWNER ADALAH DEWA`, rowId: ".donasi", description: `${namebot}`},
    ...
    {title: `💘 ${pmenus} Jadian`, rowId: ".? jadian", description: "Semoga langgeng sampai menikah ya kack!"},
    ...
    {title: `👤 ${pmenus} Host`, rowId: ".? host", description: "Check sendiri ajah"},
...
function ucapan() {
  ...
  if (time >= 10) {
    res = "Konichiwa Oni Chan >< ☀️"
  }
  if (time >= 15) {
    res = "Konichiwa Oni Chan >< 🌇"
  }
  if (time >= 18) {
